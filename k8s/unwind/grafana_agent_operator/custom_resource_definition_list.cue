...
customResourceDefinitionList: items: [{
	...
	metadata: name: "probes.monitoring.coreos.com"
	spec: {
		group: "monitoring.coreos.com"
		names: {
			categories: [
	...
	metadata: name: "grafanaagents.monitoring.grafana.com"
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							configMaps: {
								description: "ConfigMaps is a list of config maps in the same namespace as the GrafanaAgent object which will be mounted into each running Grafana Agent pod. The ConfigMaps are mounted into /etc/grafana-agent/extra-configmaps/<configmap-name>."
		...
		"""
							...
							imagePullSecrets: {
								description: "ImagePullSecrets holds an optional list of references to Secrets within the same namespace used for pulling the Grafana Agent image from registries. More info: https://kubernetes.io/docs/user-guide/images#specifying-imagepullsecrets-on-a-pod"
	...
	metadata: name: "integrations.monitoring.grafana.com"
	spec: {
		group: "monitoring.grafana.com"
		names: {
			categories: [
	...
	metadata: name: "logsinstances.monitoring.grafana.com"
	spec: {
		group: "monitoring.grafana.com"
		names: {
			categories: [
	...
	metadata: name: "metricsinstances.monitoring.grafana.com"
	spec: {
		group: "monitoring.grafana.com"
		names: {
			categories: [
	...
	metadata: name: "podlogs.monitoring.grafana.com"
	spec: {
		group: "monitoring.grafana.com"
		names: {
			categories: [
