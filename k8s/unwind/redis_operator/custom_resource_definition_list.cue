...
#CustomResourceDefinitionList: items: [{
	metadata: name: "redisfailovers.databases.spotahome.com"
	spec: {
				...
				properties: {
					...
					spec: {
						...
						properties: {
							...
							bootstrapNode: {
								description: "BootstrapSettings contains settings about a potential bootstrap node"

								properties: {
									allowSentinels: type: "boolean"
									host: type:           "string"
									port: type:           "string"
								}
								type: "object"
							...
							redis: {
								description: "RedisSettings defines the specification of the redis cluster"
		...
		"""
									...
									customCommandRenames: {
										items: {
											description: "RedisCommandRename defines the specification of a \"rename-command\" configuration option"
									...
									exporter: {
										description: "Exporter defines the specification for the redis/sentinel exporter"
		...
		"""
									...
									shutdownConfigMap: type: "string"
									startupConfigMap: type:  "string"
									storage: {
										description: "RedisStorage defines the structure used to store the Redis Data"
										...
										properties: {
											...
											keepAfterDeletion: type: "boolean"
											persistentVolumeClaim: {
		...
		"""
							...
							sentinel: {
								...
								properties: {
									...
									configCopy: {
										description: "SentinelConfigCopy defines the specification for the sentinel exporter"
