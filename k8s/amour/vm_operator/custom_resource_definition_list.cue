	...
	spec: {
		...
		"""
							...
							datasource: {
								...
								properties: {
									OAuth2: "x-kubernetes-preserve-unknown-fields": true
									basicAuth: {
										description: "BasicAuth allow an endpoint to authenticate over basic authentication"
		...
		* While dataSource only allows local objects, dataSourceRef allows objects
		...
		"""
					...
					status: {
						...
						properties: {
							availableReplicas: {
								description: "AvailableReplicas Total number of available pods (ready for at least minReadySeconds) targeted by this VMSingle."
							...
							replicas: {
								description: "ReplicaCount Total number of non-terminated pods targeted by this VMSingle."
							...
							unavailableReplicas: {
								description: "UnavailableReplicas Total number of unavailable pods targeted by this VMSingle."

								format: "int32"
								type:   "integer"
							}
							updatedReplicas: {
								description: "UpdatedReplicas Total number of non-terminated pods targeted by this VMSingle."
