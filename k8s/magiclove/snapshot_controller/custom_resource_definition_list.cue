...
#CustomResourceDefinitionList: items: [{
	metadata: {
		...
		annotations: "api-approved.kubernetes.io": "https://github.com/kubernetes-csi/external-snapshotter/pull/814"
	}
	spec: {
	...
	metadata: {
		...
		annotations: "api-approved.kubernetes.io": "https://github.com/kubernetes-csi/external-snapshotter/pull/955"
	}
	spec: {
		group: "snapshot.storage.k8s.io"
		names: {
	...
	metadata: {
		...
		annotations: "api-approved.kubernetes.io": "https://github.com/kubernetes-csi/external-snapshotter/pull/1337"
	}
	spec: {
							...
							source: {
								...
								properties: {
									groupSnapshotHandles: {
										...
										required: ["volumeGroupSnapshotHandle", "volumeSnapshotHandles"]
										type: "object"
										"x-kubernetes-validations": [{
						...
						properties: {
							...
							volumeSnapshotHandlePairList: {
								...
								items: {
									...
									required: ["snapshotHandle", "volumeHandle"]
									type: "object"
								}
								type: "array"
							}
