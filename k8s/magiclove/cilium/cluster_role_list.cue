...
#ClusterRoleList: items: [{
	...
	rules: [{
		...
		apiGroups: ["cilium.io"]
		resources: ["ciliumloadbalancerippools", "ciliumpodippools", "ciliumbgpclusterconfigs", "ciliumbgpnodeconfigoverrides", "ciliumbgppeerconfigs"]
		verbs: ["get", "list", "watch"]
	}, {
		apiGroups: ["cilium.io"]
