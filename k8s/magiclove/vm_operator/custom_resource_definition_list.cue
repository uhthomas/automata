...
#CustomResourceDefinitionList: items: [{
	metadata: name: "vlagents.operator.victoriametrics.com"
	spec: {
						...
						properties: {
							conditions: {
								items: {
									...
									required: ["lastTransitionTime", "lastUpdateTime", "reason", "status", "type"]
									type: "object"
								}
								type: "array"
	...
	metadata: name: "vlclusters.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VLCluster"
	...
	metadata: name: "vlogs.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VLogs"
	...
	metadata: name: "vlsingles.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VLSingle"
	...
	metadata: name: "vmalertmanagerconfigs.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
				...
				properties: {
					...
					status: {
						properties: {
							...
							lastErrorParentAlertmanagerName: type: "string"
							observedGeneration: {
								format: "int64"
								type:   "integer"
							}
	...
	metadata: name: "vmalertmanagers.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMAlertmanager"
	...
	metadata: name: "vmalerts.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMAlert"
	...
	metadata: name: "vmanomalies.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMAnomaly"
	...
	metadata: name: "vmauths.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMAuth"
	...
	metadata: name: "vmdistributed.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMDistributed"
	...
	metadata: name: "vmnodescrapes.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMNodeScrape"
	...
	metadata: name: "vmpodscrapes.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMPodScrape"
	...
	metadata: name: "vmrules.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMRule"
	...
	metadata: name: "vmscrapeconfigs.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMScrapeConfig"
	...
	metadata: name: "vmservicescrapes.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
	...
	metadata: name: "vmsingles.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMSingle"
	...
	metadata: name: "vmstaticscrapes.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMStaticScrape"
	...
	metadata: name: "vmusers.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VMUser"
	...
	metadata: name: "vtclusters.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VTCluster"
	...
	metadata: name: "vtsingles.operator.victoriametrics.com"
	spec: {
		group: "operator.victoriametrics.com"
		names: {
			kind:     "VTSingle"
