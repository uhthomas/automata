...
#ClusterRoleList: items: [{
	rules: [{
		...
		apiGroups: ["operator.victoriametrics.com"]
		resources: ["vmservicescrapes", "vmscrapeconfigs"]
		verbs: ["create", "delete", "get", "list", "patch", "update", "watch"]
	}, {
		apiGroups: ["operator.victoriametrics.com"]
		resources: ["vmservicescrapes/status", "vmscrapeconfigs/status"]
		verbs: ["get", "patch", "update"]
	}, {
		apiGroups: ["operator.victoriametrics.com"]
		resources: ["vmprobes"]
		...
		apiGroups: [v1.#GroupName]
		resources: ["nodes", "nodes/proxy", "nodes/metrics", "services", "endpoints", "configmaps"]
		verbs: ["get", "list", "watch"]
	}, {
