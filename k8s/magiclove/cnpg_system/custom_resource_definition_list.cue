...
#CustomResourceDefinitionList: items: [{
	...
	metadata: name: "clusterimagecatalogs.postgresql.cnpg.io"
	spec: {
		group: "postgresql.cnpg.io"
		names: {
	...
	* Other protocols should use implementation-defined prefixed names such as
	...
	"""
							...
							replicationSlots: {
								default: highAvailability: enabled: true
	...
	* While dataSource only allows local objects, dataSourceRef allows objects
	...
	"""
							...
							poolerIntegrations: {
								...
								properties: pgBouncerIntegration: {
	...
	metadata: name: "imagecatalogs.postgresql.cnpg.io"
	spec: {
		group: "postgresql.cnpg.io"
		names: {
			kind:     "ImageCatalog"
	...
	metadata: name: "poolers.postgresql.cnpg.io"
	spec: {
		group: "postgresql.cnpg.io"
		names: {
			kind:     "Pooler"
	...
	* While dataSource only allows local objects, dataSourceRef allows objects
	...
	metadata: name: "publications.postgresql.cnpg.io"
	spec: {
		group: "postgresql.cnpg.io"
		names: {
			kind:     "Publication"
	...
	metadata: name: "scheduledbackups.postgresql.cnpg.io"
	spec: {
		group: "postgresql.cnpg.io"
		names: {
