...
#CustomResourceDefinitionList: items: [{
	...
	spec: {
		...
		versions: [{
			additionalPrinterColumns: [{
				description: "The number of replicas: ready/desired"
				jsonPath:    ".status.replicaColumn"
				name:        "Replicas"
				type:        "string"
			}, {
	...
	spec: {
		...
		versions: [{
			additionalPrinterColumns: [{
				jsonPath: ".status.kanidmRef"
				name:     "Kanidm"
				type:     "string"
			}, {
				jsonPath: ".spec.entryManagedBy"
				name:     "ManagedBy"
				type:     "string"
			}, {
				jsonPath: ".status.gid"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				description: """
					The Kanidm OAuth2 client custom resource definition (CRD) defines an OAuth2 client
