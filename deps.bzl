...
def dependencies():
    ...
    http_archive(
        name = "rules_proto",
        sha256 = "3e30507806a6595c6e1f5b56462d2ead17fa47751bc539fd8aa0655f545b3fa5",
        strip_prefix = "rules_proto-ba401432feeb79a4174a134f533aef4054331343",
        urls = ["https://github.com/bazelbuild/rules_proto/archive/ba401432feeb79a4174a134f533aef4054331343.tar.gz"],
    )
    http_archive(
        name = "rules_python",
