...
#RouteSpec: {
	...
	//
	// +optional
	httpHeaders?: null | #RouteHTTPHeaders @go(HTTPHeaders,*RouteHTTPHeaders) @protobuf(9,bytes,opt)
}
...
#RouteHTTPHeaders: {
	...
	// +optional
	actions?: #RouteHTTPHeaderActions @go(Actions) @protobuf(1,bytes,opt)
}
...
#RouteHTTPHeaderActions: {
	...
	response?: [...#RouteHTTPHeader] @go(Response,[]RouteHTTPHeader) @protobuf(1,bytes,rep)
	...
	request?: [...#RouteHTTPHeader] @go(Request,[]RouteHTTPHeader) @protobuf(2,bytes,rep)
}
...
#RouteHTTPHeader: {
	...
	// +kubebuilder:validation:Required
	action: #RouteHTTPHeaderActionUnion @go(Action) @protobuf(2,bytes,opt)
}
...
#RouteHTTPHeaderActionUnion: {
	...
	// +kubebuilder:validation:Required
	type: #RouteHTTPHeaderActionType @go(Type) @protobuf(1,bytes,opt,casttype=RouteHTTPHeaderActionType)
	...
	// +optional
	// +unionMember
	set?: null | #RouteSetHTTPHeader @go(Set,*RouteSetHTTPHeader) @protobuf(2,bytes,opt)
}
...
#RouteHTTPHeaderActionType: string // #enumRouteHTTPHeaderActionType

#enumRouteHTTPHeaderActionType:
	#Set |
	#Delete
...
#RouteIngressConditionType: string // #enumRouteIngressConditionType
	...
	#RouteAdmitted |
	#RouteUnservableInFutureVersions
