...
#GrafanaLibraryPanel: {
	...
	spec:      #GrafanaLibraryPanelSpec   @go(Spec)
	status?:   #GrafanaLibraryPanelStatus @go(Status)
}

// GrafanaLibraryPanelList contains a list of GrafanaLibraryPanel
#GrafanaLibraryPanelList: {
	metav1.#TypeMeta
	metadata?: metav1.#ListMeta @go(ListMeta)
	items: [...#GrafanaLibraryPanel] @go(Items,[]GrafanaLibraryPanel)
}
