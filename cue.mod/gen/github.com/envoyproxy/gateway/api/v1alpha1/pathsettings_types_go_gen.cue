...
#PathEscapedSlashAction: string // #enumPathEscapedSlashAction

#enumPathEscapedSlashAction:
	#KeepUnchangedAction |
	#RejectRequestAction |
	#UnescapeAndRedirect |
	#UnescapeAndForward
...
#PathSettings: {
	...
	//
	// +optional
	escapedSlashesAction?: null | #PathEscapedSlashAction @go(EscapedSlashesAction,*PathEscapedSlashAction)
	...
	//
	// +optional
	disableMergeSlashes?: null | bool @go(DisableMergeSlashes,*bool)
}
