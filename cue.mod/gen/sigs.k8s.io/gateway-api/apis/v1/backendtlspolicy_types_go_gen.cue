...
#BackendTLSPolicySpec: {
	...
	targetRefs: [...#LocalPolicyTargetReferenceWithSectionName] @go(TargetRefs,[]LocalPolicyTargetReferenceWithSectionName)
...
#BackendTLSPolicyValidation: {
	...
	caCertificateRefs?: [...#LocalObjectReference] @go(CACertificateRefs,[]LocalObjectReference)
	...
	//
	// +optional
	wellKnownCACertificates?: #WellKnownCACertificatesType @go(WellKnownCACertificates,*WellKnownCACertificatesType)
	...
	//
	// +required
	hostname: #PreciseHostname @go(Hostname)
