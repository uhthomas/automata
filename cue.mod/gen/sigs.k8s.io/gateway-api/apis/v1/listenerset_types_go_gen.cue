...
#ListenerSet: {
	...
	// +optional
	status?: #ListenerSetStatus @go(Status)
}
...
#ListenerSetSpec: {
	...
	// +required
	parentRef: #ParentGatewayReference @go(ParentRef)
	...
	// +required
	listeners: [...#ListenerEntry] @go(Listeners,[]ListenerEntry)
}
...
#ListenerSetStatus: {
	...
	// +listMapKey=name
	// +kubebuilder:validation:MaxItems=64
	listeners?: [...#ListenerEntryStatus] @go(Listeners,[]ListenerEntryStatus)
}
...
// field.
#ListenerSetConditionType: string // #enumListenerSetConditionType

#enumListenerSetConditionType:
	#ListenerSetConditionProgrammed |
	#ListenerSetConditionAccepted
...
#ListenerSetConditionReason: string // #enumListenerSetConditionReason

#enumListenerSetConditionReason:
	#ListenerSetReasonProgrammed |
	#ListenerSetReasonAccepted |
	#ListenerSetReasonNotAllowed |
	#ListenerSetReasonParentNotAccepted |
	#ListenerSetReasonListenersNotValid |
	#ListenerSetReasonInvalid |
	#ListenerSetReasonPending
...
// field.
#ListenerEntryConditionType: string // #enumListenerEntryConditionType

#enumListenerEntryConditionType:
	#ListenerEntryConditionConflicted |
	#ListenerEntryConditionAccepted |
	#ListenerEntryConditionResolvedRefs |
	#ListenerEntryConditionProgrammed |
	#ListenerEntryConditionReady
...
#ListenerEntryConditionReason: string // #enumListenerEntryConditionReason

#enumListenerEntryConditionReason:
	#ListenerEntryReasonHostnameConflict |
	#ListenerEntryReasonProtocolConflict |
	#ListenerEntryReasonListenerConflict |
	#ListenerEntryReasonAccepted |
	#ListenerEntryReasonUnsupportedProtocol |
	#ListenerEntryReasonTooManyListeners |
	#ListenerEntryReasonResolvedRefs |
	#ListenerEntryReasonInvalidCertificateRef |
	#ListenerEntryReasonInvalidRouteKinds |
	#ListenerEntryReasonRefNotPermitted |
	#ListenerEntryReasonProgrammed |
	#ListenerEntryReasonPortUnavailable |
	#ListenerEntryReasonPending |
	#ListenerEntryReasonInvalid |
	#ListenerEntryReasonReady
...
#ListenerSetList: {
	...
	items: [...#ListenerSet] @go(Items,[]ListenerSet)
}
