...
#PolicyConditionReason: string // #enumPolicyConditionReason

#enumPolicyConditionReason:
	#BackendTLSPolicyReasonNoValidCACertificate |
	#BackendTLSPolicyReasonResolvedRefs |
	#BackendTLSPolicyReasonInvalidCACertificateRef |
	#BackendTLSPolicyReasonInvalidKind |
	#PolicyReasonAccepted |
	#PolicyReasonConflicted |
	#PolicyReasonInvalid |
...
#PolicyAncestorStatus: {
	...
	// +required
	ancestorRef: #ParentReference @go(AncestorRef)
...
#PolicyStatus: {
	...
	ancestors: [...#PolicyAncestorStatus] @go(Ancestors,[]PolicyAncestorStatus)
}
