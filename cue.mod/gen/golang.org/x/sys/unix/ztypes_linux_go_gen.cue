...
#FscryptPolicy: {
	...
	Flags:                     uint8
	Master_key_descriptor: 8 * [uint8] @go(,[8]uint8)
}

#FscryptKey: {
	Mode: uint32
	Raw: 64 * [uint8] @go(,[64]uint8)
	Size: uint32
}
...
#FscryptPolicyV2: {
	...
	Master_key_identifier: 16 * [uint8] @go(,[16]uint8)
}

#FscryptGetPolicyExArg: {
	Size:   uint64
	Policy: bytes @go(,[24]byte)
}
...
#DmIoctl: {
	...
	Event_nr:     uint32
	Dev:          uint64
	Name:         bytes @go(,[128]byte)
	Uuid:         bytes @go(,[129]byte)
	Data:         bytes @go(,[7]byte)
}
...
#DmTargetSpec: {
	...
	Status:       int32
	Next:         uint32
	Target_type:  bytes @go(,[16]byte)
}

#DmTargetDeps: Count: uint32
...
#RawSockaddrALG: {
	Family: uint16
	Type: 14 * [uint8] @go(,[14]uint8)
	Feat: uint32
	Mask: uint32
	Name: 64 * [uint8] @go(,[64]uint8)
}
...
#RawSockaddrPPPoX: bytes

#RawSockaddrTIPC: {
	Family:   uint16
	Addrtype: uint8
	Scope:    int8
	Addr:     bytes @go(,[12]byte)
}
...
#RawSockaddrIUCV: {
	...
	Port:   uint16
	Addr:   uint32
	Nodeid: 8 * [int8] @go(,[8]int8)
	User_id: 8 * [int8] @go(,[8]int8)
	Name: 8 * [int8] @go(,[8]int8)
}
...
#SockFprog: {
	Len:     uint16
	Filter?: null | #SockFilter @go(,*SockFilter)
}
...
#Utsname: {
	Sysname:    bytes @go(,[65]byte)
	Nodename:   bytes @go(,[65]byte)
	Release:    bytes @go(,[65]byte)
	Version:    bytes @go(,[65]byte)
	Machine:    bytes @go(,[65]byte)
	Domainname: bytes @go(,[65]byte)
}
...
#PerfBitDisabled:               uint64 & 1
#PerfBitInherit:                2
#PerfBitPinned:                 4
#PerfBitExclusive:              8
#PerfBitExcludeUser:            16
#PerfBitExcludeKernel:          32
#PerfBitExcludeHv:              64
#PerfBitExcludeIdle:            128
#PerfBitMmap:                   256
#PerfBitComm:                   512
#PerfBitFreq:                   1024
#PerfBitInheritStat:            2048
#PerfBitEnableOnExec:           4096
#PerfBitTask:                   8192
#PerfBitWatermark:              16384
#PerfBitPreciseIPBit1:          32768
#PerfBitPreciseIPBit2:          65536
#PerfBitMmapData:               131072
#PerfBitSampleIDAll:            262144
#PerfBitExcludeHost:            524288
#PerfBitExcludeGuest:           1048576
#PerfBitExcludeCallchainKernel: 2097152
#PerfBitExcludeCallchainUser:   4194304
#PerfBitMmap2:                  8388608
#PerfBitCommExec:               16777216
#PerfBitUseClockID:             33554432
#PerfBitContextSwitch:          67108864
#PerfBitWriteBackward:          134217728
...
#PERF_TXN_MAX:                          0x100
#PERF_TXN_ABORT_MASK:                   -4294967296
...
#HDDriveID: {
	...
	Vendor1:      uint16
	Vendor2:      uint16
	Serial_no: 20 * [uint8] @go(,[20]uint8)
	Buf_type:  uint16
	Buf_size:  uint16
	Ecc_bytes: uint16
	Fw_rev: 8 * [uint8] @go(,[8]uint8)
	Model: 40 * [uint8] @go(,[40]uint8)
	Max_multsect:   uint8
	Vendor3:        uint8
	Dword_io:       uint16
	Vendor4:        uint8
	...
	Words69_70: 2 * [uint16] @go(,[2]uint16)
	Words71_74: 4 * [uint16] @go(,[4]uint16)
	Queue_depth: uint16
	Words76_79: 4 * [uint16] @go(,[4]uint16)
	...
	Words104_125: 22 * [uint16] @go(,[22]uint16)
	Last_lun: uint16
	Word127:  uint16
	Dlf:      uint16
	Csfo:     uint16
	Words130_155: 26 * [uint16] @go(,[26]uint16)
	Word156: uint16
	Words157_159: 3 * [uint16] @go(,[3]uint16)
	Cfa_power: uint16
	Words161_175: 15 * [uint16] @go(,[15]uint16)
	Words176_205: 30 * [uint16] @go(,[30]uint16)
	Words206_254: 49 * [uint16] @go(,[49]uint16)
...
#LoopInfo64: {
	...
	Flags:            uint32
	File_name: 64 * [uint8] @go(,[64]uint8)
	Crypt_name: 64 * [uint8] @go(,[64]uint8)
	Encrypt_key: 32 * [uint8] @go(,[32]uint8)
	Init: 2 * [uint64] @go(,[2]uint64)
}
...
#EthtoolDrvinfo: {
	Cmd:          uint32
	Driver:       bytes @go(,[32]byte)
	Version:      bytes @go(,[32]byte)
	Fw_version:   bytes @go(,[32]byte)
	Bus_info:     bytes @go(,[32]byte)
	Erom_version: bytes @go(,[32]byte)
	Reserved2:    bytes @go(,[12]byte)
	N_priv_flags: uint32
	N_stats:      uint32
	Testinfo_len: uint32
	Eedump_len:   uint32
...
#EthtoolTsInfo: {
	...
	Phc_index:       int32
	Tx_types:        uint32
	Tx_reserved: 3 * [uint32] @go(,[3]uint32)
	Rx_filters: uint32
	Rx_reserved: 3 * [uint32] @go(,[3]uint32)
}
...
#PtpPinDesc: {
	Name:  bytes @go(,[64]byte)
	Index: uint32
	Func:  uint32
	Chan:  uint32
	Rsv: 5 * [uint32] @go(,[5]uint32)
}

#PtpSysOffset: {
	Samples: uint32
	Rsv: 3 * [uint32] @go(,[3]uint32)
	Ts: 51 * [#PtpClockTime] @go(,[51]PtpClockTime)
}
...
#PtpSysOffsetExtended: {
	...
	Clockid: int32
	Rsv: 2 * [uint32] @go(,[2]uint32)
	Ts: 25 * [3 * [#PtpClockTime]] @go(,[25][3]PtpClockTime)
}
...
#HIDRawReportDescriptor: {
	Size: uint32
	Value: 4096 * [uint8] @go(,[4096]uint8)
}
...
#NandOobinfo: {
	Useecc:   uint32
	Eccbytes: uint32
	Oobfree: 8 * [2 * [uint32]] @go(,[8][2]uint32)
	Eccpos: 32 * [uint32] @go(,[32]uint32)
}
...
#NandEcclayout: {
	Eccbytes: uint32
	Eccpos: 64 * [uint32] @go(,[64]uint32)
	Oobavail: uint32
	Oobfree: 8 * [#NandOobfree] @go(,[8]NandOobfree)
}
