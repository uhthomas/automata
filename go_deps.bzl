...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:fRMwXiwk3qDwc0P05eHnh+y2v07JdtsfQ1fuAc69m9g=",
        version = "v0.8.25",
    )
    ...
    go_repository(
        ...
        sum = "h1:482W9e2Yp8LDgTUKrXAxT+nH4pHS2TiBElI/CnfGWac=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:nOKU6xAemr5AfKmjl1R7jxC38xtnF4WEkIOsD3BCv34=",
        version = "v0.27.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:GrfUeUrJ/RtPskIsnChcXOW6h0EGNqty0VxxQ9qYKlM=",
        version = "v0.27.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:uY63v834MAHuf3fBiKGQGPq/cToU5kY5SW/58Xv0gl4=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:+4OGWAzg4JVLEauPSmyQFIfrYrYQoUsC4MbHmRuPaFU=",
        version = "v0.27.1",
    )
    go_repository(
        name = "io_k8s_cri_api",
    ...
    go_repository(
        ...
        sum = "h1:D9Hw2iBZzFPriFH0FDyUFdfflYAW6S032P6Yps9sKq8=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:4HsIhgO49Yv+C1Zsw4R18tzXgtuEfwChqOwDIi/AcxE=",
        version = "v0.27.1",
    )
    ...
    go_repository(
        ...
        replace = "k8s.io/kms",
        sum = "h1:JTSQbJb+mcobScQwF0bOmZhIwP17k8GvBsiLlA6SQqw=",
        version = "v0.27.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:FbWWHaZ1uZU+PJ7ut/HkAJ+FA8z3m1ORTYl08BSpRoc=",
        version = "v0.27.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:awlTLXvZhM/A4Nsu0ma34uKR4pHxigj9vhuQ9BHfwUk=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:Tq7ff+jUZaK8fejL4uOy1CC2B+bz2acKQ7Bf7fCtnhs=",
        version = "v0.27.1",
    )
    go_repository(
        name = "io_k8s_kubectl",
    ...
    go_repository(
        ...
        sum = "h1:IkfZ0N9CX/g6EDis7nJw8ZsOuHcpFA6cm0pXQx0g5TY=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:DFeW4Lv+kh5DyYcezOzwmQAbC3VqXAxnMyZabALiRSc=",
        version = "v1.27.1",
    )
    go_repository(
        ...
        sum = "h1:P0bzBX7gSx0yPeG9KDSspiy/M23gvLPLbwe4pYOS9bQ=",
        version = "v0.27.1",
    )
    go_repository(
        name = "io_k8s_metrics",
        ...
        sum = "h1:qIASSok+9dhKPrfAZmFreIdpgBgKTfXwkM9CQ+tNM90=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:RSd0wslbIuwLRaGGNAGMZ3m9FLcvukxJ3FWlOm76W2A=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:if4d1zzcpNOZNvljvJ0nTCshFPUmnkIsy7KYJg7FP08=",
        version = "v0.27.1",
    )
    go_repository(
        ...
        sum = "h1:/V3e0qh9uZraQVUSq+sk26XelMKJ5+ZI0dlzTUPHh3c=",
        version = "v0.27.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:MB1zkK+WMOmfLxEpjr1wEmkpcIhZC7kfTkZ0stg5bog=",
        version = "v0.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hYv1dpSwCgrykwIKWWiiYPOHyvhx4jBIGmYTgc0f1GQ=",
        version = "v0.11.1",
    )
    go_repository(
